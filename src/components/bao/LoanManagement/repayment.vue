<template>
    <div class="repayment">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" v-loading="loading">
                            ...
                            <div>
                                ...
                                <div class="listDisplay_content">
                                    <ul class="clearFix">
                                        ...
                                        <li>
                                            <p v-if="item.taskDefKey=='8'">待还款</p>
                                            <p v-if="item.taskDefKey=='9'">已还款</p>
                                            <p v-if="item.taskDefKey=='10'">已逾期</p>
                                            <p v-if="item.taskDefKey=='11'">还款失败</p>
                                            <p>状态</p>
                                        </li>
                                        <li>
                                            <p>{{item.startTime}}</p>
                                        ...
                                        <li>
                                            <router-link class="apply" tag="a"
                                                         :to="{name:'lanDetails',params:{type:'repayment',id:item.applyNum,code:item.taskDefKey}}">
                                                查看详情
                                            </router-link>
                                            <router-link class="aeapply" v-if="item.taskDefKey=='11'" tag="a"
                                                         :to="{name:'repaymentPage',params:{id:item.applyNum}}">重新还款
                                            </router-link>
                                            <router-link class="aeapply" v-if="item.taskDefKey=='8' || item.taskDefKey=='10'" tag="a"
            ...
            <el-tab-pane name="2">
                <span slot="label">待还款<el-badge :value="2" class="item"></el-badge></span>
            ...
            <el-tab-pane name="5">
                <span slot="label">还款失败<el-badge :value="5" class="item"></el-badge></span>
                <div v-loading="from_list_all == ''">
                    <el-select v-model="huankuanValue" placeholder="请选择还款方" v-if="from_list_all != []">
                        <el-option
                            v-for="item in options"

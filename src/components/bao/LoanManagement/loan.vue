<template>
    <div class="loan">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
                            ...
                            <div class="listDisplay_content">
                                <ul class="clearFix">
                                    ...
                                    <li>
                                        ...
                                        <router-link tag="a" :to="{name:'lanDetails',params:{type:'loan',id:'3'}}" class="apply" >查看详情</router-link>
            ...
            <el-tab-pane name="6">
                <span slot="label">已放款<el-badge :value="6" class="item"></el-badge></span>
                <div>
                    <ul class="form_list">
                        <li>
                            <div class="listDisplay_title clearFix">
            ...
            <el-tab-pane name="7">
                <span slot="label">已还款<el-badge :value="7" class="item"></el-badge></span>
                <div>
                    <ul class="form_list">
                        <li>
                            <div class="listDisplay_title clearFix">
            ...
            <el-tab-pane name="8">
                <span slot="label">已逾期<el-badge :value="8" class="item"></el-badge></span>
                <div>
                    <ul class="form_list">
                        <li>
                            <div class="listDisplay_title clearFix">

<template>
    <div class="financingApply">
        <header>
            <span>融资申请</span>
            <router-link class="add" :to="{name:'financingApply_add'}">立即申请</router-link>
        </header>
                        ...
                        <li>
                            <div class="listDisplay_title clearFix">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="del" ><i class="el-icon-delete"></i>删除</a>
                                </div>
                            </div>
                            <div class="listDisplay_content">
                                <ul class="clearFix">
                                    ...
                                    <li>
                                        ...
                                        <router-link class="apply" tag="a" :to="{name:'financingExamineDetails',params:{type:'apply',id:'1'}}">查看详情</router-link>
                                        <router-link class="aeapply" tag="a" :to="{name:''}">重新申请</router-link>
                                    </li>
                                </ul>
                            </div>
                        </li>
